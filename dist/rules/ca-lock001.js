...
function hasDependencyChange(before, after) {
...
function tryShowFile(repoRoot, ref, relPath) {
    try {
...
export const caLock001 = {
    ...
    async run(ctx) {
        ...
        const presentLockfiles = LOCKFILES.filter(lf => fs.existsSync(path.join(repoRoot, lf)));
