...
export function extractLeadingComments(content: string, driver: LanguageDriver): Comment[] {
...
function extractCstyle(content: string, driver: LanguageDriver): Comment[] {
...
function extractPython(content: string, driver: LanguageDriver): Comment[] {
    const rawLines = content.split('\n');
    const comments: Comment[] = [];
    let i = 0;
...
export function findCommentAtLine(content: string, lineNumber: number, driver: LanguageDriver): Comment | null {
