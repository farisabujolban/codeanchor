...
const SPEC_LOCATIONS = [
  'openapi.yaml', 'openapi.yml', 'swagger.yaml', 'swagger.json',
  'docs/openapi.yaml', 'docs/openapi.yml', 'docs/swagger.yaml', 'docs/swagger.json',
...
export const caOpenapi001: Rule = {
  id: 'CA-OPENAPI001',
  description: 'Code route not documented in OpenAPI spec, or spec has an orphaned path with no matching code route. (JS/TS frameworks in v1 — add entries to ROUTE_DETECTORS for Flask, Gin, Spring, Rails etc.)',
